...
import data_old.InBaoCaoDoanhThu;
...
public class GUI_ThongKeDoanhThu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtNgayBatDau = new extended_JComponent_old.JTextField_AllRound();
        lblNgayKetThuc = new javax.swing.JLabel();
        txtNgayKetThuc = new extended_JComponent_old.JTextField_AllRound();
        lblTongSoHoaDon = new javax.swing.JLabel();
        txtTongSoHoaDon = new extended_JComponent_old.JTextField_AllRound();
        lblTongSoQuanAo = new javax.swing.JLabel();
        txtTongSoQuanAo = new extended_JComponent_old.JTextField_AllRound();
        lblTongSoDoanhThu = new javax.swing.JLabel();
        txtTongSoDoanhThu = new extended_JComponent_old.JTextField_AllRound();
        lblTongSoDoanhThuThuan = new javax.swing.JLabel();
        txtTongSoDoanhThuThuan = new extended_JComponent_old.JTextField_AllRound();
        btnThongKe = new extended_JComponent_old.JButton_AllRound();
        btnInBaoCao = new extended_JComponent_old.JButton_AllRound();
    ...
    private extended_JComponent_old.JButton_AllRound btnInBaoCao;
    ...
    private extended_JComponent_old.JTextField_AllRound txtNgayBatDau;
    private extended_JComponent_old.JTextField_AllRound txtNgayKetThuc;
    private extended_JComponent_old.JTextField_AllRound txtTongSoDoanhThu;
    private extended_JComponent_old.JTextField_AllRound txtTongSoDoanhThuThuan;
    private extended_JComponent_old.JTextField_AllRound txtTongSoHoaDon;
    private extended_JComponent_old.JTextField_AllRound txtTongSoQuanAo;
