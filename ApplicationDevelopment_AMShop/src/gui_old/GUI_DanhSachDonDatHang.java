...
public class GUI_DanhSachDonDatHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtSoDienThoaiTimKiem = new extended_JComponent_old.JTextField_AllRound();
        btnTimKiem = new extended_JComponent_old.JButton_AllRound();
        btnXoaDonDatHang = new extended_JComponent_old.JButton_AllRound();
        ...
        tblDonDatHang = new extended_JComponent_old.JTable_LightMode();
    ...
    private extended_JComponent_old.JButton_AllRound btnXoaDonDatHang;
    ...
    private extended_JComponent_old.JTable_LightMode tblDonDatHang;
    ...
    private extended_JComponent_old.JTextField_AllRound txtSoDienThoaiTimKiem;
