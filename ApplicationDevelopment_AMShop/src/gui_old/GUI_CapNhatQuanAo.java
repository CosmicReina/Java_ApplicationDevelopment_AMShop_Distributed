...
//            error += "\n -Vui lòng chọn Hình Ảnh.";
    ...
    private void initComponents() {
        ...
        txtDonGiaNhap = new extended_JComponent_old.JTextField_AllRound();
        lblDonGiaBan = new javax.swing.JLabel();
        txtDonGiaBan = new extended_JComponent_old.JTextField_AllRound();
        ...
        btnHinhAnh = new extended_JComponent_old.JButton_AllRound();
    ...
    private extended_JComponent_old.JButton_AllRound btnHinhAnh;
    ...
    private extended_JComponent_old.JTextField_AllRound txtDonGiaBan;
    private extended_JComponent_old.JTextField_AllRound txtDonGiaNhap;
