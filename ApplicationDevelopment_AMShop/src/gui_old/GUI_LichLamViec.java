...
import data_old.FormatLocalTime;
...
public class GUI_LichLamViec extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblDanhSachLichLamViec = new extended_JComponent_old.JTable_LightMode();
        pnlDanhSachNhanVienTrongCa = new javax.swing.JPanel();
        scrDanhSachNhanVienTrongCa = new javax.swing.JScrollPane();
        tblDanhSachNhanVienTrongCa = new extended_JComponent_old.JTable_LightMode();
        ...
        txtNgayLamViec = new extended_JComponent_old.JTextField_AllRound();
        ...
        tblDanhSachNhanVien = new extended_JComponent_old.JTable_LightMode();
        pnlChamCong = new javax.swing.JPanel();
        pnlChamCongCaLam = new javax.swing.JPanel();
        btnChamCongVao = new extended_JComponent_old.JButton_AllRound();
        btnChamCongRa = new extended_JComponent_old.JButton_AllRound();
        pnlTimKiemNhanVien = new javax.swing.JPanel();
        btnThemNhanVien = new extended_JComponent_old.JButton_AllRound();
        btnXoaNhanVien = new extended_JComponent_old.JButton_AllRound();
    ...
    private extended_JComponent_old.JButton_AllRound btnChamCongRa;
    private extended_JComponent_old.JButton_AllRound btnChamCongVao;
    ...
    private extended_JComponent_old.JButton_AllRound btnXoaNhanVien;
    ...
    private extended_JComponent_old.JTable_LightMode tblDanhSachLichLamViec;
    private extended_JComponent_old.JTable_LightMode tblDanhSachNhanVien;
    private extended_JComponent_old.JTable_LightMode tblDanhSachNhanVienTrongCa;
    private extended_JComponent_old.JTextField_AllRound txtNgayLamViec;
