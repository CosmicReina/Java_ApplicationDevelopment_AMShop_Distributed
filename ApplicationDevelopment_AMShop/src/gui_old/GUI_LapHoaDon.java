...
import data_old.KhoiTaoMa;
import data_old.InHoaDon;
import data_old.UtilityJTextField;
...
public class GUI_LapHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtMaQuanAo = new extended_JComponent_old.JTextField_AllRound();
        txtTenQuanAo = new extended_JComponent_old.JTextField_AllRound();
        ...
        btnTimKiem = new extended_JComponent_old.JButton_AllRound();
        btnLamMoi = new extended_JComponent_old.JButton_AllRound();
        btnThem = new extended_JComponent_old.JButton_AllRound();
        btnXoa = new extended_JComponent_old.JButton_AllRound();
        txtSoLuong = new extended_JComponent_old.JTextField_AllRound();
        pnlLapHoaDon = new javax.swing.JPanel();
        pnlQuanAo = new javax.swing.JPanel();
        scrQuanAo = new javax.swing.JScrollPane();
        tblQuanAo = new extended_JComponent_old.JTable_LightMode();
        pnlHoaDon = new javax.swing.JPanel();
        pnlDonHang = new javax.swing.JPanel();
        scrDonHang = new javax.swing.JScrollPane();
        tblDonHang = new extended_JComponent_old.JTable_LightMode();
        pnlThongTinThanhToan = new javax.swing.JPanel();
        pnlKhachHang = new javax.swing.JPanel();
        txtHoTen = new extended_JComponent_old.JTextField_AllRound();
        txtSoDienThoai = new extended_JComponent_old.JTextField_AllRound();
        txtDiaChi = new extended_JComponent_old.JTextField_AllRound();
        btnTimKiemSDT = new extended_JComponent_old.JButton_AllRound();
        pnlThanhToan = new javax.swing.JPanel();
        lblTongTien = new javax.swing.JLabel();
        lblTienDua = new javax.swing.JLabel();
        lblTienThua = new javax.swing.JLabel();
        txtTongTien = new extended_JComponent_old.JTextField_AllRound();
        txtTienDua = new extended_JComponent_old.JTextField_AllRound();
        txtTienThua = new extended_JComponent_old.JTextField_AllRound();
        btnTaoDonDatHang = new extended_JComponent_old.JButton_AllRound();
        btnThanhToan = new extended_JComponent_old.JButton_AllRound();
    ...
    private extended_JComponent_old.JButton_AllRound btnLamMoi;
    private extended_JComponent_old.JButton_AllRound btnTaoDonDatHang;
    private extended_JComponent_old.JButton_AllRound btnThanhToan;
    private extended_JComponent_old.JButton_AllRound btnThem;
    private extended_JComponent_old.JButton_AllRound btnTimKiem;
    private extended_JComponent_old.JButton_AllRound btnTimKiemSDT;
    private extended_JComponent_old.JButton_AllRound btnXoa;
    ...
    private extended_JComponent_old.JTable_LightMode tblDonHang;
    private extended_JComponent_old.JTable_LightMode tblQuanAo;
    private extended_JComponent_old.JTextField_AllRound txtDiaChi;
    private extended_JComponent_old.JTextField_AllRound txtHoTen;
    private extended_JComponent_old.JTextField_AllRound txtMaQuanAo;
    private extended_JComponent_old.JTextField_AllRound txtSoDienThoai;
    private extended_JComponent_old.JTextField_AllRound txtSoLuong;
    private extended_JComponent_old.JTextField_AllRound txtTenQuanAo;
    private extended_JComponent_old.JTextField_AllRound txtTienDua;
    private extended_JComponent_old.JTextField_AllRound txtTienThua;
    private extended_JComponent_old.JTextField_AllRound txtTongTien;
