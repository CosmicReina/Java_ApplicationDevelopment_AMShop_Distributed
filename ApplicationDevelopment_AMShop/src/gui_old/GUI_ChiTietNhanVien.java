...
import data_old.FormatLocalDateTime;
...
public class GUI_ChiTietNhanVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtChucVu = new extended_JComponent_old.JTextField_AllRound();
        txtNgaySinh = new extended_JComponent_old.JTextField_AllRound();
        txtCCCD = new extended_JComponent_old.JTextField_AllRound();
        txtGioiTinh = new extended_JComponent_old.JTextField_AllRound();
        txtNgayBatDauLam = new extended_JComponent_old.JTextField_AllRound();
        txtNgayKetThucLam = new extended_JComponent_old.JTextField_AllRound();
        txtLuong = new extended_JComponent_old.JTextField_AllRound();
        btnXemChiTietHoaDon = new extended_JComponent_old.JButton_AllRound();
        btnQuayLai = new extended_JComponent_old.JButton_AllRound();
        scrHoaDon = new javax.swing.JScrollPane();
        tblHoaDon = new extended_JComponent_old.JTable_LightMode();
    ...
    private extended_JComponent_old.JButton_AllRound btnQuayLai;
    private extended_JComponent_old.JButton_AllRound btnXemChiTietHoaDon;
    ...
    private extended_JComponent_old.JTable_LightMode tblHoaDon;
    private extended_JComponent_old.JTextField_AllRound txtCCCD;
    private extended_JComponent_old.JTextField_AllRound txtChucVu;
    private extended_JComponent_old.JTextField_AllRound txtDiaChi;
    private extended_JComponent_old.JTextField_AllRound txtGioiTinh;
    ...
    private extended_JComponent_old.JTextField_AllRound txtNgayBatDauLam;
    private extended_JComponent_old.JTextField_AllRound txtNgayKetThucLam;
