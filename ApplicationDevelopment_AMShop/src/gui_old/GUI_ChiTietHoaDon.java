...
public class GUI_ChiTietHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtMaHoaDon = new extended_JComponent_old.JTextField_AllRound();
        txtNhanVienLapDon = new extended_JComponent_old.JTextField_AllRound();
        txtKhachHang = new extended_JComponent_old.JTextField_AllRound();
        txtThoiGianTao = new extended_JComponent_old.JTextField_AllRound();
        txtTongTien = new extended_JComponent_old.JTextField_AllRound();
        txtTienKhachDua = new extended_JComponent_old.JTextField_AllRound();
        txtTienThua = new extended_JComponent_old.JTextField_AllRound();
        btnXemFileHoaDon = new extended_JComponent_old.JButton_AllRound();
    ...
    private extended_JComponent_old.JButton_AllRound btnXemFileHoaDon;
    ...
    private extended_JComponent_old.JTextField_AllRound txtKhachHang;
    private extended_JComponent_old.JTextField_AllRound txtMaHoaDon;
    private extended_JComponent_old.JTextField_AllRound txtNhanVienLapDon;
    private extended_JComponent_old.JTextField_AllRound txtThoiGianTao;
    private extended_JComponent_old.JTextField_AllRound txtTienKhachDua;
