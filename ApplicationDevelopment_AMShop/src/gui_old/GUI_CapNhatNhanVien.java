...
public class GUI_CapNhatNhanVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblTable = new extended_JComponent_old.JTable_LightMode();
        pnlCenter = new javax.swing.JPanel();
        pnlDangNhap = new javax.swing.JPanel();
        lblTenDangNhap = new javax.swing.JLabel();
        lblMatKhau = new javax.swing.JLabel();
        txtTenDangNhap = new extended_JComponent_old.JTextField_AllRound();
        txtMauKhau = new extended_JComponent_old.JPasswordField_AllRound();
        pnlNhanVien = new javax.swing.JPanel();
        txtMaNhanVien = new extended_JComponent_old.JTextField_AllRound();
        txtHoTen = new extended_JComponent_old.JTextField_AllRound();
        txtCCCD = new extended_JComponent_old.JTextField_AllRound();
        txtSoDienThoai = new extended_JComponent_old.JTextField_AllRound();
        txtNgaySinh = new extended_JComponent_old.JTextField_AllRound();
        txtLuong = new extended_JComponent_old.JTextField_AllRound();
        ...
        btnCapNhat = new extended_JComponent_old.JButton_AllRound();
        btnLamMoi = new extended_JComponent_old.JButton_AllRound();
        btnTimKiemTheoMa = new extended_JComponent_old.JButton_AllRound();
        btnTimKiemTheoThongTin = new extended_JComponent_old.JButton_AllRound();
    ...
    private extended_JComponent_old.JButton_AllRound btnCapNhat;
    private extended_JComponent_old.JButton_AllRound btnLamMoi;
    private extended_JComponent_old.JButton_AllRound btnTimKiemTheoMa;
    private extended_JComponent_old.JButton_AllRound btnTimKiemTheoThongTin;
    ...
    private extended_JComponent_old.JTable_LightMode tblTable;
    private extended_JComponent_old.JTextField_AllRound txtCCCD;
    ...
    private extended_JComponent_old.JTextField_AllRound txtLuong;
    private extended_JComponent_old.JTextField_AllRound txtMaNhanVien;
    private extended_JComponent_old.JPasswordField_AllRound txtMauKhau;
    private extended_JComponent_old.JTextField_AllRound txtNgaySinh;
    private extended_JComponent_old.JTextField_AllRound txtSoDienThoai;
    private extended_JComponent_old.JTextField_AllRound txtTenDangNhap;
