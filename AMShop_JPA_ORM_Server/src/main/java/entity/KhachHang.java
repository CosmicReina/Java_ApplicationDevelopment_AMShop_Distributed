...
@NamedQueries({@NamedQuery(name = "KhachHang.getAllKhachHang", query = "SELECT kh FROM KhachHang kh"),
		...
		@NamedQuery(name = "KhachHang.getSoTienKhachHangDaThanhToanTheoMaKhachHang", query = "SELECT SUM(hd.tienKhachDua) FROM HoaDon hd WHERE hd.khachHang.maKhachHang = :maKhachHang")})
