...
public class GUI_Main extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		btnLapHoaDon = new extended_component.JButton_AllRound();
		btnDanhSachDonDatHang = new extended_component.JButton_AllRound();
		btnDanhSachNhanVien = new extended_component.JButton_AllRound();
		btnTimKiemNhanVien = new extended_component.JButton_AllRound();
		btnThemNhanVien = new extended_component.JButton_AllRound();
		btnCapNhatNhanVien = new extended_component.JButton_AllRound();
		btnThongTinNhanVien = new extended_component.JButton_AllRound();
		btnDanhSachKhachHang = new extended_component.JButton_AllRound();
		btnTimKiemKhachHang = new extended_component.JButton_AllRound();
		btnCapNhatKhachHang = new extended_component.JButton_AllRound();
		btnDanhSachHoaDon = new extended_component.JButton_AllRound();
		btnTimKiemHoaDon = new extended_component.JButton_AllRound();
		btnDanhSachQuanAo = new extended_component.JButton_AllRound();
		btnTimKiemQuanAo = new extended_component.JButton_AllRound();
		btnThemQuanAo = new extended_component.JButton_AllRound();
		btnCapNhatQuanAo = new extended_component.JButton_AllRound();
		btnDanhSachLichLamViec = new extended_component.JButton_AllRound();
		btnTinhLuong = new extended_component.JButton_AllRound();
		btnThongKeDoanhThu = new extended_component.JButton_AllRound();
		btnThongKeKhachHang = new extended_component.JButton_AllRound();
		btnThongKeQuanAoDaBan = new extended_component.JButton_AllRound();
		btnThongKeQuanAoDaHet = new extended_component.JButton_AllRound();
		pnlTitle = new extended_component.JPanel_AllRound();
		lblTitle = new javax.swing.JLabel();
		pnlButton = new extended_component.JPanel_AllRound();
		pnlActionButton = new extended_component.JPanel_AllRound();
		btnTrangChu = new extended_component.JButton_AllRound();
		btnNhanVien = new extended_component.JButton_AllRound();
		btnKhachHang = new extended_component.JButton_AllRound();
		btnHoaDon = new extended_component.JButton_AllRound();
		btnQuanAo = new extended_component.JButton_AllRound();
		btnLichLamViec = new extended_component.JButton_AllRound();
		btnThongKe = new extended_component.JButton_AllRound();
		vg = new javax.swing.Box.Filler(new java.awt.Dimension(0, 0), new java.awt.Dimension(0, 0),
				new java.awt.Dimension(0, 32767));
		pnlLogoutButton = new extended_component.JPanel_AllRound();
		btnDangXuat = new extended_component.JButton_AllRound();
		...
		pnlWorkLayout.setHorizontalGroup(pnlWorkLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGap(0, 1166, Short.MAX_VALUE));
		pnlWorkLayout.setVerticalGroup(pnlWorkLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnNhanVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhanVienActionPerformed
        GUI_MainFrame.getInstance().actionTaoPopupChoButton(btnNhanVien, listBtnNhanVien);
    }//GEN-LAST:event_btnNhanVienActionPerformed

    private void btnKhachHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKhachHangActionPerformed
        GUI_MainFrame.getInstance().actionTaoPopupChoButton(btnKhachHang, listBtnKhachHang);
    }//GEN-LAST:event_btnKhachHangActionPerformed

    private void btnHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHoaDonActionPerformed
        GUI_MainFrame.getInstance().actionTaoPopupChoButton(btnHoaDon, listBtnHoaDon);
    }//GEN-LAST:event_btnHoaDonActionPerformed

    private void btnQuanAoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuanAoActionPerformed
        GUI_MainFrame.getInstance().actionTaoPopupChoButton(btnQuanAo, listBtnQuanAo);
    ...
    private void btnLichLamViecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLichLamViecActionPerformed
        GUI_MainFrame.getInstance().actionTaoPopupChoButton(btnLichLamViec, listBtnLichLamViec);
    }//GEN-LAST:event_btnLichLamViecActionPerformed

    private void btnThongKeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThongKeActionPerformed
        GUI_MainFrame.getInstance().actionTaoPopupChoButton(btnThongKe, listBtnThongKe);
    ...
    private void btnLapHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLapHoaDonActionPerformed
        ...
        GUI_MainFrame.getInstance().actionXoaPopup();
    ...
    private void btnThongTinNhanVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThongTinNhanVienActionPerformed
        ...
        GUI_ChiTietNhanVien.getInstance().showChiTietNhanVien(Configuration_Client.getNhanVienHienTai());
	...
	private extended_component.JButton_AllRound btnCapNhatKhachHang;
	private extended_component.JButton_AllRound btnCapNhatNhanVien;
	private extended_component.JButton_AllRound btnCapNhatQuanAo;
	private extended_component.JButton_AllRound btnDangXuat;
	private extended_component.JButton_AllRound btnDanhSachDonDatHang;
	private extended_component.JButton_AllRound btnDanhSachHoaDon;
	private extended_component.JButton_AllRound btnDanhSachKhachHang;
	private extended_component.JButton_AllRound btnDanhSachLichLamViec;
	private extended_component.JButton_AllRound btnDanhSachNhanVien;
	private extended_component.JButton_AllRound btnDanhSachQuanAo;
	private extended_component.JButton_AllRound btnHoaDon;
	private extended_component.JButton_AllRound btnKhachHang;
	private extended_component.JButton_AllRound btnLapHoaDon;
	private extended_component.JButton_AllRound btnLichLamViec;
	private extended_component.JButton_AllRound btnNhanVien;
	private extended_component.JButton_AllRound btnQuanAo;
	...
	private extended_component.JButton_AllRound btnThongKeDoanhThu;
	private extended_component.JButton_AllRound btnThongKeKhachHang;
	private extended_component.JButton_AllRound btnThongKeQuanAoDaBan;
	private extended_component.JButton_AllRound btnThongKeQuanAoDaHet;
	private extended_component.JButton_AllRound btnThongTinNhanVien;
	private extended_component.JButton_AllRound btnTimKiemHoaDon;
	private extended_component.JButton_AllRound btnTimKiemKhachHang;
	private extended_component.JButton_AllRound btnTimKiemNhanVien;
	private extended_component.JButton_AllRound btnTimKiemQuanAo;
	private extended_component.JButton_AllRound btnTinhLuong;
	private extended_component.JButton_AllRound btnTrangChu;
	private javax.swing.JLabel lblTitle;
	private extended_component.JPanel_AllRound pnlActionButton;
	private extended_component.JPanel_AllRound pnlButton;
	private extended_component.JPanel_AllRound pnlLogoutButton;
	private extended_component.JPanel_AllRound pnlTitle;
