...
public class GUI_DanhSachHoaDon extends javax.swing.JPanel {
	...
	private static final long serialVersionUID = -137170882233082190L;
	...
	private void hienThiBang(List<HoaDon> list) throws RemoteException, MalformedURLException, NotBoundException {
		...
		for (HoaDon thisHoaDon : list) {
			...
			listCTHD = ServiceInitiator.getInstance()
			...
			model.addRow(new Object[]{thisHoaDon.getMaHoaDon(), thisHoaDon.getNhanVien().getHoTen(),
					thisHoaDon.getKhachHang().getHoTen(), thisHoaDon.getKhachHang().getSoDienThoai(),
	...
	private void initComponents() {
		...
		pnlTimKiem.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Xem Chi Tiết",
		...
		pnlTimKiemLayout
				.setVerticalGroup(pnlTimKiemLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(pnlTimKiemLayout.createSequentialGroup()
								.addGap(12, 12, 12)
								.addComponent(btnXemChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

		add(pnlTimKiem, java.awt.BorderLayout.SOUTH);

		tblDanhSachHoaDon.setModel(new javax.swing.table.DefaultTableModel(new Object[][]{

		}, new String[]{"Mã Hóa Đơn", "Nhân Viên Lập Đơn", "Tên Khách Hàng", "Số Điện Thoại", "Ngày Lập Hóa Đơn",
				"Tổng Tiền"}));
