...
public class GUI_ThemNhanVien extends javax.swing.JPanel {
	...
	private static final long serialVersionUID = 5853757342728075426L;
		...
		try {
			...
			if(canCuocCongDan.equals("Căn Cước Công Dân")) // Kiểm tra rỗng
			    ...
			    if(!canCuocCongDan.matches("[0-9]{12}")) // Kiểm tra biểu thức chính quy
			        ...
			        if(ServiceInitiator.getInstance().getServiceNhanVien().getNhanVienTheoCanCuocCongDan(canCuocCongDan) != null) // Kiểm tra đã tồn tại
			...
			if(soDienThoai.equals("Số Điện Thoại")) // Kiểm tra rỗng
			    ...
			    if(!soDienThoai.matches("0{1}[0-9]{9}")) // Kiểm tra biểu thức chính quy
			        ...
			        if(ServiceInitiator.getInstance().getServiceNhanVien().getNhanVienTheoSoDienThoai(soDienThoai) != null) // Kiểm tra đã tồn tại
			...
			if(error.equals("")){
			    NhanVien nhanVien = new NhanVien(maNhanVien, hoTen, soDienThoai, diaChi, chucVu, canCuocCongDan, gioiTinh, ngaySinh, ngayBatDauLam, ngayKetThucLam, luong, matKhau);
			    if(ServiceInitiator.getInstance().getServiceNhanVien().createNhanVien(nhanVien) == true){
		...
		pnlNhanVienLayout.setHorizontalGroup(pnlNhanVienLayout
				...
				.addGroup(pnlNhanVienLayout.createSequentialGroup()
						.addGroup(pnlNhanVienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(pnlNhanVienLayout.createSequentialGroup()
										.addGap(12, 12, 12)
										.addComponent(btnThem, javax.swing.GroupLayout.PREFERRED_SIZE, 200,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(18, 18, 18)
										.addComponent(btnLamMoi, javax.swing.GroupLayout.PREFERRED_SIZE, 200,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
