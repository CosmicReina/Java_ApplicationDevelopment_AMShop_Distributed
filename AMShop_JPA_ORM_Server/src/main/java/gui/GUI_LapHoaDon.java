...
public class GUI_LapHoaDon extends javax.swing.JPanel {
	...
	private static final long serialVersionUID = 3031270011550188939L;
	...
	private void initExtra() {
		try {
			capNhatTblQuanAo(ServiceInitiator.getInstance().getServiceQuanAo().getAllQuanAo());
			...
			List<NhaSanXuat> listNhaSanXuatObject = ServiceInitiator.getInstance()
					.getServiceNhaSanXuat()
					.getAllNhaSanXuat();
			List<String> listNhaSanXuat = new ArrayList<>();
			for (NhaSanXuat thisNhaSanXuat : listNhaSanXuatObject)
				listNhaSanXuat.add(thisNhaSanXuat.getTenNhaSanXuat());
	...
	private void capNhatTblQuanAo(List<QuanAo> list) {
	...
	private void capNhatTblDonHang(List<ChiTietHoaDon> list) {
		tongTien = 0;
		...
		for (ChiTietHoaDon thisChiTietHoaDon : list) {
			...
			model.addRow(new Object[]{thisChiTietHoaDon.getQuanAo().getMaQuanAo(),
					thisChiTietHoaDon.getQuanAo().getTenQuanAo(), thisChiTietHoaDon.getSoLuong(),
	...
	private void taoDonDatHang() {
		try {
			...
			int prompt = JOptionPane.showConfirmDialog(null, "Xác Nhận Tạo Đơn Đặt Hàng?", "Tạo Đơn Đặt Hàng",
			...
			boolean themDonDatHang = ServiceInitiator.getInstance().getServiceDonDatHang().createDonDatHang(donDatHang);

			for (ChiTietHoaDon thisChiTietHoaDon : listDonHang) {
				ChiTietDonDatHang chiTietDonDatHang = new ChiTietDonDatHang(donDatHang, thisChiTietHoaDon.getQuanAo(),
						thisChiTietHoaDon.getSoLuong());
				ServiceInitiator.getInstance().getServiceChiTietDonDatHang().createChiTietDonDatHang(chiTietDonDatHang);
	...
	private void lapHoaDon() {
		try {
			...
			int prompt = JOptionPane.showConfirmDialog(null, "Xác Nhận Thanh Toán Cho Đơn Hàng Này?", "Xác Nhận Thanh Toán",
					JOptionPane.YES_NO_OPTION);
			if (prompt == JOptionPane.NO_OPTION)
				return;
			...
			for (ChiTietHoaDon thisChiTietHoaDon : listDonHang) {
				...
				ServiceInitiator.getInstance().getServiceChiTietHoaDon().createChiTietHoaDon(thisChiTietHoaDon);
			...
			if (themHoaDon) {
				...
				KhachHang khachHangDaMua = ServiceInitiator.getInstance().getServiceKhachHang().getKhachHangTheoMaKhachHang(hoaDon.getKhachHang().getMaKhachHang());
				if (khachHangDaMua.getNhomKhachHang().equals("Thường")) {
					double soTienKhachHangDaMua = ServiceInitiator.getInstance().getServiceKhachHang().getSoTienKhachHangDaThanhToanTheoMaKhachHang(khachHangDaMua.getMaKhachHang());
					if (soTienKhachHangDaMua > 10000000) {
						khachHangDaMua.setNhomKhachHang("Thân Thiết");
						ServiceInitiator.getInstance().getServiceKhachHang().updateKhachHang(khachHangDaMua);
					}
				}
	...
	private void initComponents() {
		...
		pnlTimKiem.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tìm Kiếm Quần Áo",
		...
		pnlTimKiemLayout.setHorizontalGroup(pnlTimKiemLayout
				...
				.addGroup(pnlTimKiemLayout.createSequentialGroup()
						.addGroup(pnlTimKiemLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(pnlTimKiemLayout.createSequentialGroup()
										.addContainerGap()
										.addGroup(pnlTimKiemLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
												.addComponent(cmbKichThuoc, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
												.addComponent(cmbGioiTinh, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
												.addComponent(cmbNhaSanXuat, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
										...
										.addGroup(pnlTimKiemLayout
												...
												.addComponent(cmbMauSac, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
												.addComponent(cmbChatLieu, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)))
								.addGroup(pnlTimKiemLayout.createSequentialGroup()
										.addGap(21, 21, 21)
								...
								.addComponent(txtMaQuanAo, javax.swing.GroupLayout.Alignment.TRAILING,
		...
		pnlTimKiemLayout.setVerticalGroup(pnlTimKiemLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(pnlTimKiemLayout.createSequentialGroup()
						.addComponent(txtMaQuanAo, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(txtTenQuanAo, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		pnlKhachHangLayout.setHorizontalGroup(pnlKhachHangLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlKhachHangLayout.createSequentialGroup()
						...
						.addGroup(pnlKhachHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(pnlKhachHangLayout.createSequentialGroup()
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(btnTimKiemSDT, javax.swing.GroupLayout.PREFERRED_SIZE, 230,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										pnlKhachHangLayout.createSequentialGroup()
												.addGap(3, 3, 3)
		...
		pnlKhachHangLayout.setVerticalGroup(pnlKhachHangLayout
				...
				.addGroup(pnlKhachHangLayout.createSequentialGroup()
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(
								pnlKhachHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(btnTimKiemSDT, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		pnlThanhToanLayout.setVerticalGroup(pnlThanhToanLayout
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlThanhToanLayout.createSequentialGroup()
						...
						.addGroup(pnlThanhToanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								...
								.addComponent(btnTaoDonDatHang, javax.swing.GroupLayout.PREFERRED_SIZE, 41,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(pnlThanhToanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
