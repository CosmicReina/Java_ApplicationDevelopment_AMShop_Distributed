...
public class GUI_ThongKeDoanhThu extends javax.swing.JPanel {
	...
	private static final long serialVersionUID = 4450098418548545766L;
	...
	private void updateTable() {
		try {
			...
			List<HoaDon> listHD = ServiceInitiator.getInstance()
					.getServiceHoaDon()
					.getAllHoaDonTrongKhoangNgay(LocalDateTime.of(ngayBatDau, LocalDateTime.MIN.toLocalTime()),
			...
			for (HoaDon thisHoaDon : listHD) {
				...
				for (ChiTietHoaDon thisChiTietHoaDon : listCTHD) {
					...
					tongDoanhThuThuanThanhPhan += thisChiTietHoaDon.getSoLuong()
							* (thisChiTietHoaDon.getDonGia() - thisChiTietHoaDon.getQuanAo().getDonGiaNhap());
				...
				model.addRow(new Object[]{thisHoaDon.getMaHoaDon(), thisHoaDon.getNhanVien().getHoTen(),
						...
						Integer.toString(tongQuanAoThanhPhan), FormatDouble.toMoney(tongDoanhThuThanhPhan)});
	...
	private void inBaoCaoThongKe() {
		try {
			...
			if (InBaoCaoDoanhThu.createBaoCaoDoanhThu(LocalDateTime.of(ngayBatDau, LocalDateTime.MIN.toLocalTime()),
					LocalDateTime.of(ngayKetThuc, LocalDateTime.MAX.toLocalTime())) == true) {
	...
	private void initComponents() {
		...
		scrHoaDon.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh Sách Hóa Đơn",
		...
		}, new String[]{"Mã Hóa Đơn", "Tên Nhân Viên", "Tên Khách Hàng", "Ngày Lập Đơn", "Số Quần Áo", "Tổng Tiền"}));
		...
		pnlThongKe.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thống Kê Doanh Thu",
				javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP,
				new java.awt.Font("Segoe UI", 0, 24), new java.awt.Color(255, 255, 255))); // NOI18N
		...
		pnlThongKeLayout.setHorizontalGroup(pnlThongKeLayout
				...
				.addComponent(txtTongSoHoaDon, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addComponent(txtTongSoQuanAo, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlThongKeLayout.createSequentialGroup()
						...
						.addGroup(pnlThongKeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(lblTongSoHoaDon, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
								.addComponent(lblNgayBatDau, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
								.addComponent(lblTongSoQuanAo, javax.swing.GroupLayout.DEFAULT_SIZE, 278,
										Short.MAX_VALUE)
								.addComponent(lblTongSoDoanhThu, javax.swing.GroupLayout.DEFAULT_SIZE, 278,
										Short.MAX_VALUE)
								.addComponent(lblTongSoDoanhThuThuan, javax.swing.GroupLayout.DEFAULT_SIZE, 278,
										Short.MAX_VALUE)
								...
								.addComponent(btnThongKe, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap())
				.addComponent(txtTongSoDoanhThuThuan, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		pnlThongKeLayout.setVerticalGroup(pnlThongKeLayout
				...
				.addGroup(pnlThongKeLayout.createSequentialGroup()
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(txtTongSoHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(lblTongSoQuanAo)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(txtTongSoQuanAo, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(txtTongSoDoanhThuThuan, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
